...
export class OrganizationManagementComponent implements OnInit {
  ...
  openEditModal(node: OrganizationNode): void {
    ...
    this.nodeForm.patchValue({
      ...
      certificateNo: node.certificateNo || '',
      workHistory: node.workHistory || '',
      keyExperience: node.keyExperience || '',
  ...
  onSubmit(): void {
    ...
    const payload: Partial<OrganizationNode> = {
      ...
      birthYear: formVal.birthYear ? Number(formVal.birthYear) : undefined,
      certificateNo: formVal.certificateNo || '',
      workHistory: formVal.workHistory || '',
      keyExperience: formVal.keyExperience || '',
